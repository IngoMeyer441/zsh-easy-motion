...
try:
    from typing import (  # noqa: F401  # pylint: disable=unused-import
        cast, AnyStr, Callable, Dict, IO, Iterable, List, Optional, Text, Tuple, Union
    )
except ImportError:
...
VALID_MOTIONS = ('b', 'B', 'ge', 'gE', 'e', 'E', 'w', 'W', 'f', 'F', 't', 'T', 's')
...
def main():
    ...
    try:
        ...
        MissingCursorPositionError, InvalidCursorPositionError, InvalidMotionError, MissingMotionError,
        MissingMotionArgumentError, MissingTextError
    ) as e:
